...
const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // resolve var(--x) palette refs — canvas fillStyle can't read CSS vars
      ...
      if (gradient && Array.isArray(gradient) && gradient.length >= 2) {
        ...
        gradient.forEach((c, i) => grad.addColorStop(i / (gradient.length - 1), resolveColor(c)));
      ...
      // reduced motion: draw one still frame instead of the vibrating loop
      ...
      if (glitchMode && !prefersReduced) startGlitchLoop();
