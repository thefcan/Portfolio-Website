...
const CircularText: React.FC<CircularTextProps> = ({
  ...
  useEffect(() => {
    // reduced motion: the badge sits still — letters stay laid out in a circle
  ...
  }, [spinDuration, text, onHover, controls, prefersReducedMotion]);
  ...
  return (
    <motion.div
      className={`relative mx-auto origin-center rounded-full text-center ${className}`}
